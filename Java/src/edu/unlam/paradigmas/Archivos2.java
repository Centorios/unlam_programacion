...
public class Archivos2 {
    ...
    public Archivos2(String nombre) {
        this.nombre = nombre;
    }
    ...
    public int [] leerArchivo() {
        ...
        try {
            File file = new File("src/edu/unlam/paradigmas/casos de prueba/in/" + this.nombre + ".in");
    ...
    public void guardarArchivo(double[] datos) {
        ...
        try {
            file = new FileWriter("src/edu/unlam/paradigmas/casos de prueba/casos de prueba/out/" + this.nombre + ".out");
