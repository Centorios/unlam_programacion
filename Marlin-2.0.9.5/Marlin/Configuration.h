...
#define STRING_CONFIG_H_AUTHOR "(Alejo Burnowicz - Centorios, Anet A8 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pomada Anet A8+"
...
//#deepromfine MAX31865_CALIBRATION_OHMS_1 430
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ANET A8 Standard Extruder at 215 Degree Celsius and 100% Fan
  // (measured after M106 S255 with M303 E0 S210 C8)
  #if ENABLED(PID_PARAMS_PER_HOTEND)
    // Specify up to one value per hotend here, according to your setup.
    // If there are fewer values, the last one applies to the remaining hotends.
    #define DEFAULT_Kp_LIST {  64.30,  64.30 }
    #define DEFAULT_Ki_LIST {   7.69,   7.69 }
    #define DEFAULT_Kd_LIST {  134.36,  134.36 }
  #else
    #define DEFAULT_Kp 54.8
    #define DEFAULT_Ki  5.76
    #define DEFAULT_Kd 130.1
  #endif
#endif
